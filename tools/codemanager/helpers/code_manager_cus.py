...
class CodeManager:
    ...
    def _execute_catching_errors(
        ...
        try:
            ...
            # If not, add it.
            if " = " + self.func_name + "(" not in code:
                code += "\n\nresult = " + self.func_name + "(df)"

            exec(code, environment)
        except Exception as exc:
            print("Error of executing code")
...
{code_to_run}
        ...
        print("keep runing")
        analyze_data = environment.get(self.func_name, None)

        try:
            output = analyze_data(self._get_original_df())
        except:
            print("analyze error")
            output = None
            code_to_run = None

        return output, code_to_run
